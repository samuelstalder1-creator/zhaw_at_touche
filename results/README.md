...
For `setup110`, the prediction JSONL rows also include the six learned
pair-distance feature values.
...
- No committed `results/setup110/` directory exists yet; that setup is active
