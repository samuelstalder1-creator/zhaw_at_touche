...
from zhaw_at_touche.anchor_distance_threshold import (
    load_anchor_distance_threshold_state,
    score_formula,
    score_records,
)
...
def build_parser(setup_defaults: dict[str, object] | None = None) -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Evaluate a handcrafted anchor-distance score between query, Gemini/Qwen neutrals, and the response."
    )
    ...
    parser.add_argument(
        ...
        help="Directory containing the saved embedding_state.json threshold/state bundle.",
    )
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    saved_state = load_anchor_distance_threshold_state(model_dir)
    ...
    if threshold is None:
        ...
        calibration_predictions = score_records(
            ...
            progress_prefix="setup111 calibration",
        )
    ...
    for primary_path, secondary_path in zip(args.input_files, args.aux_input_files, strict=True):
        ...
        predictions = score_records(
            ...
            batch_size=args.batch_size,
            max_length=args.max_length,
            progress_prefix=f"setup111 eval {primary.stem}",
        )
        ...
        for index, record in enumerate(records):
            ...
            output_row: dict[str, Any] = {
                ...
                "anchor_cohesion": prediction.anchor_cohesion,
                "response_drift": prediction.response_drift,
            }
