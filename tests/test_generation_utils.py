...
class GenerationUtilsTests(unittest.TestCase):
    ...
    def test_model_alias(self) -> None:
        ...
        self.assertEqual(model_alias("gemma4:26b"), "gemma4_26b")
    ...
    def test_default_backend_for_provider(self) -> None:
        ...
        self.assertEqual(default_backend_for_provider("gemma426b"), "openai_compatible")
    ...
    def test_generate_neutral_cli_defaults_for_gemma426b(self) -> None:
        args = build_parser().parse_args(["--provider", "gemma426b", "--split", "validation"])

        self.assertEqual(resolve_backend(args), "openai_compatible")
        self.assertEqual(resolve_model(args), "gemma4:26b")
